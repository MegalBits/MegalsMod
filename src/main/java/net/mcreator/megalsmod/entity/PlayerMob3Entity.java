...
public class PlayerMob3Entity extends MegalsmodModElements.ModElement {
	public static EntityType entity = null;
	public PlayerMob3Entity(MegalsmodModElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("player_mob_3")
						.setRegistryName("player_mob_3");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3355444, new Item.Properties().group(PlayerMobsItemGroup.tab))
				.setRegistryName("player_mob_3_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("megalsmod:textures/colour.png");
					}
				};
