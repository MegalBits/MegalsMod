...
import net.mcreator.megalsmod.block.CharredDirtBlock;
...
public class CharredForestBiome extends MegalsmodModElements.ModElement {
	public static Biome biome;
	public CharredForestBiome(MegalsmodModElements instance) {
		super(instance, 29);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-13949148).withGrassColor(-13685722).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BurntGrassBlock.block.getDefaultState(),
								CharredDirtBlock.block.getDefaultState(), CharredDirtBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("megalsmod:charred_forest"));
			}
		}
	}
	@Override
