...
import net.mcreator.megalsmod.itemgroup.BlocksItemGroup;
...
public class BurntGrassBlock extends MegalsmodModElements.ModElement {
	@ObjectHolder("megalsmod:charred_grass")
	public static final Block block = null;
	public BurntGrassBlock(MegalsmodModElements instance) {
		super(instance, 27);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.6f, 3f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("charred_grass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CharredDirtBlock.block, (int) (1)));
		}
	}
}
