...
public class DeepoceanedgeRender1Block extends MegalsmodModElements.ModElement {
	@ObjectHolder("megalsmod:deepoceanedge_render_1")
	public static final Block block = null;
	public DeepoceanedgeRender1Block(MegalsmodModElements instance) {
		super(instance, 11);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deepoceanedge_render_1");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
			{
				...
				DeepoceanRender1UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("megalsmod:deep_ocean_edge").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
